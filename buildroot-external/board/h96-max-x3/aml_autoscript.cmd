...
#
# Strategy: Load uImage + DTB from FAT boot partition, boot HAOS directly.
# The mainline boot.scr needs commands this U-Boot doesn't have,
# so we implement a minimal A-slot boot here.
#
...
# SD card is mmc 0 in vendor U-Boot
# Memory addresses from vendor U-Boot env
